...
| `aiv-guard.yml` | AIV_GUARD | `60ea728` |
...
| Source File | Packet(s) | Commit(s) |
|---|---|---|
| `pre-commit` | PRECOMMIT, PRECOMMIT_HOOK_FIX, SNAPSHOT_WINDOWS_FIX | `0b00c63`, `b25af40`, `c4128a1` |
...
| `main.py` | AIV_AUDIT_FIXES, AUDIT_CLI_COMMAND, CI_LINT_FORMAT, CLI_CLEANUP, CLI_MAIN, FALSIFIABILITY_GUIDED_GEN, GENERATE_CMD, GENERATOR_CLASS_E_FIX, SVP_IMPL | `3665936`, `3842564`, `464c063`, `4784c47`, `8b8f941`, `9214766`, `bc3982e`, `d56b589`, `fea5aed` |
...
| `security.py` | DEAD_MODULE_REMOVAL, SECURITY | `cc9905f`, `e06ee44` |
...
### `src\aiv\lib\analyzers/`

| Source File | Packet(s) | Commit(s) |
|---|---|---|
| `__init__.py` | AIV_AUDIT_FIXES, ANALYZERS_INIT | `aa2a1ec`, `e1ebeb7` |
| `diff.py` | DEAD_MODULE_REMOVAL, DIFF_ANALYZER | `cd78eda`, `e06ee44` |
...
| `evidence.py` | AIV_AUDIT_FIXES, CI_LINT_FORMAT, CLI_CLEANUP, EVIDENCE_COHERENCE_E020, EVIDENCE_RULES, EVIDENCE_VALIDATOR, PARSER_ENRICHMENT, ZEROTOUCH_FIX | `0d6b1ea`, `67f7580`, `7fb04c2`, `8a50936`, `8f70926`, `a4617d2`, `c26371a` |
| `exceptions.py` | DEAD_MODULE_REMOVAL, EXCEPTIONS | `7f6bd04`, `e06ee44` |
...
| Source File | Packet(s) | Commit(s) |
|---|---|---|
| `__init__.py` | AIV_AUDIT_FIXES | `4e87dcb` |

### `src\svp\cli/`

| Source File | Packet(s) | Commit(s) |
|---|---|---|
| `__init__.py` | AIV_AUDIT_FIXES | `191f034` |
| `main.py` | AIV_AUDIT_FIXES | `694a960` |

### `src\svp\lib/`

| Source File | Packet(s) | Commit(s) |
|---|---|---|
| `__init__.py` | AIV_AUDIT_FIXES | `513351a` |
| `models.py` | AIV_AUDIT_FIXES | `9a94125` |

### `src\svp\lib\validators/`

| Source File | Packet(s) | Commit(s) |
|---|---|---|
| `__init__.py` | AIV_AUDIT_FIXES | `41d9b88` |
| `session.py` | AIV_AUDIT_FIXES | `592b54a` |
...
| `test_e2e_compliance.py` | CI_LINT_FORMAT, CRITIQUE_TEST_GAPS, E2E_COMPLIANCE_TESTS, E2E_TEST_FIXES, FALSIFIABILITY_CT013 | `245e786`, `5998e73`, `90557ff`, `dca3d1f`, `dd4daf0` |
...
| AIV_INIT | `src/aiv/__init__.py` | `575c11e` |
| ANALYZERS_INIT | `src/aiv/lib/analyzers/__init__.py` | `aa2a1ec` |
...
| ANTI_CHEAT | `src/aiv/lib/validators/anti_cheat.py` | `fa7f0ac` |
...
| CLI_INIT | `src/aiv/cli/__init__.py` | `9292c8e` |
| CLI_MAIN | `src/aiv/cli/main.py` | `3665936` |
| CONFIG | `src/aiv/lib/config.py` | `5cfb386` |
| CONFTEST | `tests/conftest.py` | `8903f10` |
...
| DIFF_ANALYZER | `src/aiv/lib/analyzers/diff.py` | `cd78eda` |
...
| ERRORS | `src/aiv/lib/errors.py` | `16c0ced` |
...
| EXCEPTIONS | `src/aiv/lib/validators/exceptions.py` | `7f6bd04` |
...
| GITIGNORE | `.gitignore` | `83c5a1c` |
| GUARD_INIT | `src/aiv/guard/__init__.py` | `f39fff5` |
...
| LIB_INIT | `src/aiv/lib/__init__.py` | `e7c55f9` |
| LINKS_CLEANUP | `src/aiv/lib/validators/links.py` | `3eedd50` |
| LINKS_VALIDATOR | `src/aiv/lib/validators/links.py` | `12b2287` |
...
| MODELS | `src/aiv/lib/models.py` | `547b126` |
...
| PARSER | `src/aiv/lib/parser.py` | `8aee121` |
...
| PIPELINE | `src/aiv/lib/validators/pipeline.py` | `7fb5f3c` |
...
| PYPROJECT | `pyproject.toml` | `2c3d2eb` |
| PY_TYPED | `src/aiv/py.typed` | `6be32ea` |
| SECURITY | `src/aiv/guard/security.py` | `cc9905f` |
| SNAPSHOT_WINDOWS_FIX | `.husky/pre-commit` | `0b00c63` |
| STRUCTURE_VALIDATOR | `src/aiv/lib/validators/structure.py` | `a5ba911` |
...
| TEST_INTEGRATION_INIT | `tests/integration/__init__.py` | `270136e` |
| TEST_MODELS | `tests/unit/test_models.py` | `90830ab` |
...
| TEST_UNIT_INIT | `tests/unit/__init__.py` | `7e4ae3f` |
| TEST_WORKFLOW | `tests/integration/test_full_workflow.py` | `12147f1` |
| VALIDATORS_INIT | `src/aiv/lib/validators/__init__.py` | `3d299a7` |
| VALIDATOR_BASE | `src/aiv/lib/validators/base.py` | `e6b12e7` |
...
| ZERO_TOUCH | `src/aiv/lib/validators/zero_touch.py` | `4cc63e2` |
